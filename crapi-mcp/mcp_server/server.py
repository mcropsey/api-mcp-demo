...
# ── Config ─────────────────────────────────────────────────────────────────────
API_BASE = "http://192.168.1.101:8888"

# Paste the token returned by the login tool here, then restart Claude Desktop
AUTH_TOKEN = "eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiJtaWtlMUBteS5sYWIiLCJpYXQiOjE3ODAwODg0MTAsImV4cCI6MTc4MDY5MzIxMCwicm9sZSI6InVzZXIifQ.ep33N-c4UAxhkbhxSeuHtqb1nhQOucK9tqukrcMIXgdlqpp3KZP_kg4mrdRYhOFNA7l4ocxzLy-veajMNb7C9qtfeb0kvCP2nmvzowxOYxdjzOKaG6AqsgWNB-pCgIQgXmHcpVdxBW06IgaVoDRjXvQHTa_WsspXXeJOOaTHEZHh9f7nfDcWCQvfad4346z4PCkjXcH8PFwPEtKWT2l82zyrCoSlUlcXkdn1cD06PkH5fRn7RA8IY0TeYmZ_ev7MuAkiS1aU1kd_WShmqHpNqYnm01uGJFIJlh-5FGun42aNSobp849gyEiS3Zv7u3eYR2RgmfellAqC4fBmcQ2SXg"
...
async def list_tools():
    return [
        ...
        types.Tool(
            name="login",
            description="Log in to crAPI and return a JWT token. Paste the token into AUTH_TOKEN in server.py and restart Claude Desktop.",
            inputSchema={
                "type": "object",
                "properties": {
        ...
        if name == "login":
            try:
                ...
                return [types.TextContent(type="text", text=(
                    f"Login successful.\n\nToken:\n{token}\n\n"
                    "Paste this into AUTH_TOKEN in server.py, then restart Claude Desktop."
                ))]
            except Exception as e:
                return err(e)
